...
class FruitsControllerTest < ActionController::TestCase
  ...
  test "should create fruit" do
    assert_difference('Fruit.count') do
      post :create, fruit: { description: @fruit.description, image: @fruit.image, latinName: @fruit.latinName, name: @fruit.name, otherNames: @fruit.otherNames }
    end
  ...
  test "should update fruit" do
    patch :update, id: @fruit, fruit: { description: @fruit.description, image: @fruit.image, latinName: @fruit.latinName, name: @fruit.name, otherNames: @fruit.otherNames }
    assert_redirected_to fruit_path(assigns(:fruit))
  end
